...
// Return all models.
// curl -s "localhost:8081/models/?format=xml"
// curl -s "localhost:8081/models/?format=xml&name=1"
server.get(
  '/models',
  function (request, response, next)
    {
...
// curl -s "localhost:8081/models/hemostat.js?format=json" > test.js 
server.get(
  '/models/:model',
  function (request, response, next)
    {
...
// Load a new model.  
// curl -X PUT --data-binary @test.js "localhost:8081/models/test.js"
server.put(
  '/models/:model',
  function (request, response, next)
    {
...
// Delete a model.  
// curl -X DELETE "localhost:8081/models/test.js"
server.del(
  '/models/:model',
  function (request, response, next)
    {
